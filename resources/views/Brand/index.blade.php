...
<a href="{{route('Brand.create')}}" class="bg-amber-400 text-black px-4 py-2 rounded-lg shadow-amber-300">Add Brand</a>
</div>
<table id="myTable" class="display">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>{{$brand->name}}</td>
            <td>
                <a href="{{route('Brand.edit',$brand->id)}}" class="bg-blue-600 text-white px-2 py-1 rounded hover:shadow-blue-400">Edit</a>
                <a onclick="showDelete('{{$brand->id}}')" class="bg-red-600 text-white px-2 py-1 rounded shadow hover:shadow-red-400 cursor-pointer">Delete</a>
             </td>
        </tr>
        @endforeach
    </tbody>
