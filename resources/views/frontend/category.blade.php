          ...
          <div class="row">
              ...
              <div class="card sidebar-menu mb-4">
                ...
                <div class="card-body">
                  <ul class="nav nav-pills flex-column category-menu">
                   ...
                   <li><a href="{{route('frontend.category', $categoryitem -> id)}}" class="nav-link" style="color: black; font-weight: bold;">{{$categoryitem->name}} <span class="badge badge-secondary"></span></a>
                      <ul class="list-unstyled">
                      
                          
                        @foreach ($categoryitem->sub_category as $sub_category)
                        <li><a href="{{route('frontend.subcategory', $sub_category -> id)}}" class="nav-link" style="color: black; font-weight: bold;">{{$sub_category->name}}</a></li> 
            ...
            <div class="col-lg-9">
              ...
              <div class="box info-bar">
                <div class="row">
                  <div class="col-md-12 col-lg-4 products-showing" style="margin-left:17rem;">Showing <strong></strong>  <strong></strong> products</div>
